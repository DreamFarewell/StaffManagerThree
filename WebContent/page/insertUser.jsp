...
<body>
	...
	<div align="right" style="padding-right: 38.56%;padding-bottom: 3px;"><button class="page_b" onclick="home()">首页</button></div>
	<div align="center">
		<form name="myForm" action="${pageContext.request.contextPath }/super/insertUser.action" method="post">
		<div align="center">
		<table class="table_style">
			<tr class="tr_d_style"><td class="td_style">用户名:</td><td class="td"><input type="text" class="input_text" name="user"/></td></tr>
			<tr class="tr_d_style"><td class="td_style">密 码:</td><td class="td"><input type="text" class="input_text" name="password"/></td></tr>
			<tr class="tr_d_style"><td class="td_style">用户类型:</td><td class="tdd"><select class="select_bg" name="type"><option value="ordinary">管理员</option></select></td></tr>
			<tr class="tr_d_style"><td align="center" colspan="2"><input type="submit" class="page_b" value="提交"/></td></tr>
		</table>
		</div>
		</form>
	</div>
